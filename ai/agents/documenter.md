...
Focus: documentation quality, consistency, and release notes.
...
- Maintain project documentation (dev/)
...
**Escalate to architect when:** Documentation reveals missing architectural decisions or conflicts
**Escalate to planner when:** Milestone breakdown or sequencing is unclear
