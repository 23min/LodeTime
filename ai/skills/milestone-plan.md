...
- `dev/architecture/<epic-slug>/README.md` exists
...
5) Write/update a **Milestone Plan** section in `dev/architecture/<epic-slug>/README.md`:
   - Milestone ID + title
   - Goal/outcome
...
Outputs:
- Milestone plan recorded in `dev/architecture/<epic-slug>/README.md`
