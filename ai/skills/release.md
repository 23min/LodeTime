...
Confirm that `dev/epics/releases/<epic-slug>.md` exists and is complete with:
...
See dev/epics/releases/<epic-slug>.md for details."
...
- Description: Copy from `dev/epics/releases/<epic-slug>.md`
...
- **Documentation link**: Epic slug maps to `dev/epics/releases/<epic-slug>.md`
