...
- Must match the epic slug in `dev/architecture/<epic-slug>/` and `dev/epics/active/<epic-slug>.md`
...
3. Milestone ID is used in:
   - Milestone spec filename: `dev/milestones/M-<epic-slug>-XX.md`
   - Tracking doc: `dev/milestones/tracking/M-<epic-slug>-XX-tracking.md`
