...
- **Single source of truth:**
  - Architect: `work/epics/**`, epic scope/decisions, merge strategy
  - Planner: Milestone Plan section in `work/epics/<epic-slug>/README.md`
  - Documenter: `work/epics/**`, `work/milestones/**` (specs), `CHANGELOG.md`
...
## Gap handling
- Gaps are out-of-scope by default; record them in `work/epics/epic-roadmap.md` or `ROADMAP.md`
